...
export const idl = {
  ...
  structs: [
    {
      name: "0x1::test_coin::Capabilities",
      fields: [
        {
          name: "mint_cap",
          ty: {
      ...
      fields: [
        {
          ...
          ty: {
            vector: {
              struct: { name: "0x1::test_coin::DelegatedMintCapability" },
            },
          },
        },
      ],
