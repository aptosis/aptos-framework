...
/**
 * Payload arguments for {@link StakeModule.add_stake}.
 */
...
/**
 * Payload arguments for {@link StakeModule.increase_lockup}.
 */
...
/**
 * Payload arguments for {@link StakeModule.join_validator_set}.
 */
...
/**
 * Payload arguments for {@link StakeModule.leave_validator_set}.
 */
...
/**
 * Payload arguments for {@link StakeModule.register_validator_candidate}.
 */
...
/**
 * Payload arguments for {@link StakeModule.rotate_consensus_key}.
 */
...
/**
 * Payload arguments for {@link StakeModule.set_delegated_voter}.
 */
...
/**
 * Payload arguments for {@link StakeModule.set_operator}.
 */
...
/**
 * Payload arguments for {@link StakeModule.unlock}.
 */
...
export const entrypoints = {
  ...
  withdraw: (): p.ScriptFunctionPayload => ({
  ...
  add_stake: ({ args }: AddStakePayload): p.ScriptFunctionPayload => ({
    type: "script_function_payload",
  ...
  increase_lockup: ({
    args,
  }: IncreaseLockupPayload): p.ScriptFunctionPayload => ({
    type: "script_function_payload",
  ...
  join_validator_set: ({
    args,
  }: JoinValidatorSetPayload): p.ScriptFunctionPayload => ({
    type: "script_function_payload",
  ...
  leave_validator_set: ({
    args,
  }: LeaveValidatorSetPayload): p.ScriptFunctionPayload => ({
    type: "script_function_payload",
  ...
  register_validator_candidate: ({
    args,
  }: RegisterValidatorCandidatePayload): p.ScriptFunctionPayload => ({
    type: "script_function_payload",
  ...
  rotate_consensus_key: ({
    args,
  }: RotateConsensusKeyPayload): p.ScriptFunctionPayload => ({
    type: "script_function_payload",
  ...
  set_delegated_voter: ({
    args,
  }: SetDelegatedVoterPayload): p.ScriptFunctionPayload => ({
    type: "script_function_payload",
  ...
  set_operator: ({ args }: SetOperatorPayload): p.ScriptFunctionPayload => ({
    type: "script_function_payload",
  ...
  unlock: ({ args }: UnlockPayload): p.ScriptFunctionPayload => ({
    type: "script_function_payload",
...
export const errors = {
  ...
  ENO_COINS_TO_WITHDRAW: {
    code: 12,
    name: "ENO_COINS_TO_WITHDRAW",
    doc: "No coins in inactive state to withdraw from specified pool.",
  },
  ENO_POST_GENESIS_VALIDATOR_SET_CHANGE_ALLOWED: {
    code: 15,
