...
export const add_validator = ({
  ...
  function: "0x1::validator_set_script::add_validator",
  type_arguments: [],
...
export const create_validator_account = ({
  ...
  type: "script_function_payload",
  function: "0x1::validator_set_script::create_validator_account",
  type_arguments: [],
  arguments: [
...
export const create_validator_operator_account = ({
  ...
  type: "script_function_payload",
  function: "0x1::validator_set_script::create_validator_operator_account",
  type_arguments: [],
  arguments: [
    p.serializers.hexString(args._new_account_address),
    p.serializers.hexString(args._human_name),
...
export const register_validator_config = ({
  ...
  type: "script_function_payload",
  function: "0x1::validator_set_script::register_validator_config",
  type_arguments: [],
  arguments: [
...
export const remove_validator = ({
  ...
  type: "script_function_payload",
  function: "0x1::validator_set_script::remove_validator",
  type_arguments: [],
  arguments: [p.serializers.hexString(args._validator_addr)],
});
...
export const set_validator_config_and_reconfigure = ({
  ...
  type: "script_function_payload",
  function: "0x1::validator_set_script::set_validator_config_and_reconfigure",
  type_arguments: [],
  arguments: [
...
export const set_validator_operator = ({
  ...
  type: "script_function_payload",
  function: "0x1::validator_set_script::set_validator_operator",
  type_arguments: [],
  arguments: [
